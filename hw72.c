 ...
 int main()
{
   int width;
   int height;
   double **f,**newf,**f0,**gof, **gof0, **ngof0;
   double x, y;
   int i, j;

// if reading in picture
ifstream infile("towerblurry.bmp", ios::in | ios::binary);
 f = readpicture(infile,width,height);
   infile.close();

ifstream infile1("towerblurrynoisy.bmp", ios::in | ios::binary);
